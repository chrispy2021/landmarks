...
def run(
            ...
            ### publish odom start
                        ...
                        if view_img:
                            ...
                            if MAKE_RANDOM_SCREENSHOTS:
                                ...
                                if rand_int < 100:
                                    cv2.imwrite(f"LAB42DATASET/YOLOV9SCREENSHOTSLAB42/y9pic{screenshot_idx}.png", im0)
    ...
    # 1718875920.6145875 1718875927.1196764 1718877218.1935692
    # 6.505088806152344 1291.0738928318024

    #lab42
#     1719403726.0617797 1719403727.4846075 1719406390.5312967
# 1.4228277206420898 2663.046689271927
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'v9best.pt', help='model path or triton URL')
